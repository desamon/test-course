...
from functions import login, element_is_present, wait_until_clickable, wait_until_present, wait_until_visible
...
def test_about_myself_page():
   with Chrome() as browser:
       ...
       login(browser)
       wait_until_clickable(browser, By.NAME, "name").send_keys("Имя")
       ...
       wait_until_clickable(browser, By.NAME, "name").send_keys(Keys.ENTER) #ENTER в "Имя"
